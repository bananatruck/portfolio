...
export function ContactSection() {
    return (
        <div className="py-24 sm:py-36 relative overflow-hidden bg-background">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 space-y-16 py-4">
                ...
                <motion.div
                    ...
                    className="text-center my-6 sm:my-10"
                >
                    <h1 className="text-4xl md:text-6xl font-black font-serif uppercase tracking-widest text-foreground">
                        <span className="text-foreground border-b-4 border-foreground pb-2">Contacts</span>
                    </h1>
                </motion.div>
                    ...
                    {socialLinks.map((link, index) => {
                        ...
                        return (
                            <motion.a
                                ...
                                className="group relative p-5 sm:p-7 manga-panel hover:bg-foreground transition-all duration-300 overflow-hidden cursor-target flex flex-col items-center text-center gap-4 shadow-[6px_6px_0px_0px_hsl(var(--foreground))]"
                            >
                                <div className="p-3.5 border-2 border-foreground rounded-full group-hover:border-background group-hover:bg-background/10 transition-colors">
                                    <Icon className="w-6 h-6 text-foreground group-hover:text-background" />
                                </div>
                                <div>
                                    <h3 className="text-base sm:text-lg font-mono font-bold text-foreground group-hover:text-background transition-colors uppercase">
                                        {link.name}
                                    </h3>
                                    <p className="text-xs text-foreground/60 mt-1 group-hover:text-background/80 font-serif">
                                        {link.description}
                                    </p>
                                </div>
                            </motion.a>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-mono pt-4">
                    ...
                    <motion.div
                        ...
                        className="p-6 border-3 border-foreground bg-background shadow-[6px_6px_0px_0px_hsl(var(--foreground))] space-y-4"
                    >
                        ...
                        <p className="text-xs sm:text-sm font-serif leading-relaxed text-foreground/80">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-xs pt-1">
                            <span className="px-2 py-1 border border-foreground/40 bg-foreground/5 font-bold">Magisk / KernelSU</span>
                            <span className="px-2 py-1 border border-foreground/40 bg-foreground/5 font-bold">LineageOS</span>
                            <span className="px-2 py-1 border border-foreground/40 bg-foreground/5 font-bold">Android ROM Ricing</span>
                        </div>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="p-6 border-3 border-foreground bg-background shadow-[6px_6px_0px_0px_hsl(var(--foreground))] space-y-4 flex flex-col justify-between"
                    >
                        <div className="flex items-center justify-between border-b-2 border-foreground/30 pb-3">
                            <div className="flex items-center gap-2 font-bold uppercase tracking-wider text-xs sm:text-sm">
